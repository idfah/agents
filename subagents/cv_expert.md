...
name: cv_expert
description: >-
  Computer vision and imagery expert covering classical and modern ML-based
  methods. Reviews image processing, image formats and shapes, and pixel/chip-level
  concepts. Use when a review should be scoped strictly to computer vision and
  imagery.
claude:
