...
description: >-
  Core repository maintainer and advocate for existing conventions. Reviews whether
  changes align with established style, patterns, contracts and existing
  functionality. Use when a review should be scoped strictly to consistency with
