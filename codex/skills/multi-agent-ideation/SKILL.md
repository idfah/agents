...
Launch all subagents concurrently with no inherited conversation context.
Give each the same core brief plus its role-specific perspective.  Tell each
agent to work independently, not delegate and not consult other agents.
