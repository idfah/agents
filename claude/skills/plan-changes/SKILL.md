---
name: plan-changes
description: Make a plan or generate a revised plan to implement a code change.  Use when asked to plan, or to revise a plan for, a set of changes before implementing them.
---
...
- Do not make any changes; this is a planning step only.  The only possible
  ...
  written to a file.
- Present the plan in the response.  Do not use the plan-mode approval flow
  unless the user asks to enter plan mode.
